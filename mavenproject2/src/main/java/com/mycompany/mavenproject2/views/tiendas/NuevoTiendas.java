 ...
 * @author joshuansu
 */
public class NuevoTiendas extends javax.swing.JDialog {

    private final RefCDOutlet MG;
     ...
     * @param mg
     */
    public NuevoTiendas(java.awt.Dialog parent, boolean modal, RefCDOutlet mg) {
        super(parent, modal);
        initComponents();
        if (mg == null) {
            lastCode = null;
    ...
    private void llenarDatos() {
        ...
        detalles.setText(MG.getDescription());
    ...
    private void guardar() {
        ...
        if (!detalles.getText().trim().equals("")) {
            MG.setDescription(detalles.getText().trim());
        }
        try {
            RefCDOutletBD.getInstance().saveCDOutlet(MG, lastCode);
            dispose();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
